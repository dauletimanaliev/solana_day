// Fixed Solana Wallet Integration
// ===============================
...
class SolanaWalletManager {
    ...
    async connectPhantom() {
        ...
        try {
            ...
            if (window.solana.isConnected) {
                ...
                // Use the correct method to trigger Phantom popup
    ...
    // Force wallet connection (for testing)
    async forceConnect(walletType) {
        console.log(`🔧 Force connecting to ${walletType}...`);
